            ...
            if ($stmt) {
                ...
                if ($result->num_rows === 1) {
                    ...
                    if (password_verify($password, $user['password'])) {
                        // Check if user is admin - block admin login on regular login page
                        $userRole = $user['role'] ?? 'user';
                        
                        if ($userRole === 'admin') {
                            $error = 'Administrators must use the <a href="login_admin.php">Admin Login</a> page.';
                        } else {
...
<body class="login-page">
  ...
  <main class="container login-container">
    <div class="login-card">
      <h2>User Login</h2>
      <p style="color: #666; font-size: 14px; margin-bottom: 20px;">Regular users login here. Administrators should use <a href="login_admin.php">admin login</a>.</p>
      ...
      <p class="muted">
        <a href="login_admin.php" style="color: #666;">Admin Login →</a> | 
