...
<body class="login-page">
  ...
  <main class="container login-container">
    <div class="login-card">
      <h2>Admin Login</h2>
      <p style="color: #666; font-size: 14px; margin-bottom: 20px;">Administrators only. Regular users should use the <a href="login.php">regular Sign In</a>.</p>
      ...
      <p class="muted" style="margin-top: 20px;">
        <a href="login.php" style="color: #666;">← Regular Sign In</a> | 
